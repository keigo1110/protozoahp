        ...
        <section className="w-full py-12 bg-gradient-to-b from-gray-900/30 to-blue-950/30 border-t border-b border-blue-800/50 relative z-10">
          <div className="max-w-5xl mx-auto text-center text-blue-100 px-4">
            ...
            <p className="mb-8 text-lg md:text-xl">
              本作品集は、カンブリア紀の海底に棲む生物たちをモチーフにしたインタラクティブアート展示です。
              <br /><br />
              約5億4000万年前、地球上の生命が爆発的に多様化した「カンブリア爆発」の時代。
              奇妙で神秘的な形態を持つ生物たちが海底に存在していました。
              <br /><br />
              それらの原始的な生命体の動きや形態からインスピレーションを得て制作された作品群を、
              インタラクティブな形でお楽しみください。画面上の生物をタップすると、その生物が独自の動きで反応します。
            </p>
          </div>
        </section>
